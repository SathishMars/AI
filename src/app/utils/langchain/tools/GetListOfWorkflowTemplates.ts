...
import { z } from 'zod';
import { WorkflowTemplateDbUtil } from '../../workflowTemplateDbUtil';
...
export const GetListOfWorkflowTemplatesTool = tool(listToolFunc, {
    ...
    schema: getListOfWorkflowTemplatesSchema,
});
